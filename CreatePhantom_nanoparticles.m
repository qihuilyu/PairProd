...
phantom_nanoparticles = ones(nx,ny,nz)*airHU;
mask0 = ((x-(1+nx)/2).^2/(60.^2)+(y-(1+ny)/2).^2/(50.^2)<1 & z<80 & z>20);
phantom_nanoparticles(mask0) = waterHU;
figure;imshow3D(phantom_nanoparticles,[-1000,1600])
...
for ii = 1:ninserts
    ...
    phantom_nanoparticles(mask) = mathu(ii);
end
...
mkdir('D:\datatest\PairProd\phantom_nanoparticles\')
save('D:\datatest\PairProd\phantom_nanoparticles\phantom_nanoparticles.mat','phantom_nanoparticles','BODY')
